...
./ns3 configure --enable-modules core,network,internet,applications,point-to-point,modular-transport,udp --build-profile=debug
./ns3 build
...
# gdb build/scratch/mt_test/ns3-dev-mt_test-debug
